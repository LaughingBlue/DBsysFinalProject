    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "848330021940163",
               appSecret: "9ed8d176e5a38bfb1f8ac2b0ffc5c4fe");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "365702266701-4p5hb0urtf8hdt0pj6prtu77ondleuqr.apps.googleusercontent.com",
                ClientSecret = "mfeMiLBOIdacUzyNkgepv0Ul"
            });
        }
    }
}